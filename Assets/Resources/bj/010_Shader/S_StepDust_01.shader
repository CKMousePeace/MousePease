...
Shader "FX/S_StepDust_01"
{
	Properties
	{
		...
		[ASEBegin]_step("step", Float) = 0.47
		_distortion_5("distortion_5", 2D) = "white" {}
		_T_Smoke_06("T_Smoke_06", 2D) = "white" {}
		_T_Cloud_03("T_Cloud_03", 2D) = "white" {}
		_inten("inten", Float) = 0
		_mask_1("mask_1", 2D) = "white" {}
		_T_Smoke_05("T_Smoke_05", 2D) = "white" {}
		[ASEEnd]_dis("dis", Range( 0 , 5)) = 5
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _T_Smoke_06_ST;
			float4 _mask_1_ST;
			float4 _T_Smoke_05_ST;
			float _inten;
			float _step;
			float _dis;
			...
			#endif
			CBUFFER_END
			sampler2D _T_Smoke_06;
			sampler2D _T_Cloud_03;
			sampler2D _mask_1;
			sampler2D _T_Smoke_05;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_T_Smoke_06 = IN.ase_texcoord3.xy * _T_Smoke_06_ST.xy + _T_Smoke_06_ST.zw;
				float2 texCoord85 = IN.ase_texcoord3.xy * float2( 0.5,0.5 ) + float2( 0.25,0.25 );
				float2 CenteredUV15_g2 = ( texCoord85 - float2( 0.5,0.5 ) );
				...
				float2 panner86 = ( 1.0 * _Time.y * float2( -0.5,0 ) + appendResult23_g2);
				float2 uv_mask_1 = IN.ase_texcoord3.xy * _mask_1_ST.xy + _mask_1_ST.zw;
				float temp_output_122_0 = ( tex2D( _T_Cloud_03, panner86 ).r - ( tex2D( _mask_1, uv_mask_1 ).r * 0.28 ) );
				float smoothstepResult57 = smoothstep( 0.0 , _step , ( tex2D( _T_Smoke_06, uv_T_Smoke_06 ).r - temp_output_122_0 ));
				float2 uv_T_Smoke_05 = IN.ase_texcoord3.xy * _T_Smoke_05_ST.xy + _T_Smoke_05_ST.zw;
				float4 texCoord91 = IN.ase_texcoord4;
				texCoord91.xy = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult117 = lerp( smoothstepResult57 , ( tex2D( _T_Smoke_05, uv_T_Smoke_05 ).r - temp_output_122_0 ) , texCoord91.z);
				float2 texCoord69 = IN.ase_texcoord3.xy * float2( 0.2,0.2 ) + float2( 0,0 );
				float mulTime120 = _TimeParameters.x * 0.3;
				float cos118 = cos( mulTime120 );
				float sin118 = sin( mulTime120 );
				float2 rotator118 = mul( texCoord69 - float2( 0,0 ) , float2x2( cos118 , -sin118 , sin118 , cos118 )) + float2( 0,0 );
				float temp_output_67_0 = ( lerpResult117 - ( texCoord91.w * tex2D( _distortion_5, rotator118 ).r ) );
				float smoothstepResult133 = smoothstep( 0.0 , 0.36 , temp_output_67_0);
				float4 screenPos = IN.ase_texcoord5;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth126 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth126 = saturate( abs( ( screenDepth126 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _dis ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * _inten ).rgb;
				float Alpha = ( ( IN.ase_color.a * saturate( smoothstepResult133 ) ) * distanceDepth126 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_T_Smoke_06 = IN.ase_texcoord2.xy * _T_Smoke_06_ST.xy + _T_Smoke_06_ST.zw;
				float2 texCoord85 = IN.ase_texcoord2.xy * float2( 0.5,0.5 ) + float2( 0.25,0.25 );
				float2 CenteredUV15_g2 = ( texCoord85 - float2( 0.5,0.5 ) );
				float2 break17_g2 = CenteredUV15_g2;
				float2 appendResult23_g2 = (float2(( length( CenteredUV15_g2 ) * 1.0 * 2.0 ) , ( atan2( break17_g2.x , break17_g2.y ) * ( 1.0 / TWO_PI ) * 1.0 )));
				float2 panner86 = ( 1.0 * _Time.y * float2( -0.5,0 ) + appendResult23_g2);
				...
				float temp_output_122_0 = ( tex2D( _T_Cloud_03, panner86 ).r - ( tex2D( _mask_1, uv_mask_1 ).r * 0.28 ) );
				float smoothstepResult57 = smoothstep( 0.0 , _step , ( tex2D( _T_Smoke_06, uv_T_Smoke_06 ).r - temp_output_122_0 ));
				float2 uv_T_Smoke_05 = IN.ase_texcoord2.xy * _T_Smoke_05_ST.xy + _T_Smoke_05_ST.zw;
				float4 texCoord91 = IN.ase_texcoord3;
				texCoord91.xy = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult117 = lerp( smoothstepResult57 , ( tex2D( _T_Smoke_05, uv_T_Smoke_05 ).r - temp_output_122_0 ) , texCoord91.z);
				float2 texCoord69 = IN.ase_texcoord2.xy * float2( 0.2,0.2 ) + float2( 0,0 );
				float mulTime120 = _TimeParameters.x * 0.3;
				float cos118 = cos( mulTime120 );
				float sin118 = sin( mulTime120 );
				float2 rotator118 = mul( texCoord69 - float2( 0,0 ) , float2x2( cos118 , -sin118 , sin118 , cos118 )) + float2( 0,0 );
...
/*ASEBEGIN
Version=18935
338;340;1569;773;-101.4034;207.8808;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;129;197.6863,312.6418;Inherit;False;Property;_dis;dis;7;0;Create;True;0;0;0;False;0;False;5;0.97;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;126;561.7682,298.0681;Inherit;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;702.228,-16.81717;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;140;2;13;0
WireConnection;140;3;128;0
ASEEND*/
//CHKSM=10C94E175DA83B9EFC35EF0B86B34E736DCDB5E2