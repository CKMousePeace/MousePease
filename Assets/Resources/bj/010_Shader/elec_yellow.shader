...
Shader "elec_yellow"
{
	Properties
	{
		...
		[ASEBegin]_intencity1("intencity", Float) = 2.13
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode16 = tex2D( _spark_22, uv_spark_22 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * _intencity1 * tex2DNode16.r ).rgb;
				float Alpha = ( tex2DNode16.r * IN.ase_color.a );
...
/*ASEBEGIN
Version=18935
437.6;470.4;1170.4;588.6;206.7216;-320.848;1;True;True
...
ASEEND*/
//CHKSM=D97A77E1AA65A1A66AB37D62BAAA09B3DB7F63D8